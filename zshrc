...
alias docker_rm='docker rm $(docker ps -qa)'
alias docker_rmi='docker rmi -f $(docker images -q)'

# terraform
alias tffmt="terraform fmt -recursive"
alias tf_clean_cache='sudo find . -name ".terraform" -exec rm -r "{}" \;'
alias tg_clean_cache='find . -name ".terragrunt-cache" -exec rm -r "{}" \;'
